 ...
 * @returns {string | null}
 */
export function parseTime(oriTime, cFormat) {
  if (arguments.length === 0 || !oriTime) {
    return null;
  }
  let time = oriTime;
 ...
 * @returns {string}
 */
export function formatTime(oriTime, option) {
  let time = oriTime;
...
export function createUniqueString() {
  ...
  const randomNum = String(parseInt((1 + Math.random()) * 65536, 10));
